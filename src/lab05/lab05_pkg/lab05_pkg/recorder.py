...
class RecorderNode(Node):
    ...
    def save_data(self):
        ...
        odom_path = Path.cwd() / 'lab05/lab05_pkg/lab05_pkg/odom.npy'
        filter_path = Path.cwd() / 'lab05/lab05_pkg/lab05_pkg/filter.npy'
        gt_path = Path.cwd() / 'lab05/lab05_pkg/lab05_pkg/ground_truth.npy'
